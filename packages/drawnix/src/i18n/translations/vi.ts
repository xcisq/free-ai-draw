...
const viTranslations: Translations = {
    ...
    // PaperDraw
    'extraTools.paperdrawToFlowchart': 'PaperDraw Lưu đồ',
    'dialog.paperdraw.description': 'Nhập văn bản mô tả phương pháp nghiên cứu hoặc quy trình, AI sẽ tự động trích xuất thực thể và quan hệ để tạo lưu đồ.',
    'dialog.paperdraw.placeholder': 'Nhập mô tả văn bản tại đây...',
    'dialog.paperdraw.analyze': 'Phân tích',
    'dialog.paperdraw.analyzing': 'Đang phân tích...',
    'dialog.paperdraw.skip': 'Bỏ qua',
    'dialog.paperdraw.confirm': 'Xác nhận',
    'dialog.paperdraw.insert': 'Chèn vào bảng',
    'dialog.paperdraw.configTitle': 'Cấu hình LLM',
    'dialog.paperdraw.apiKey': 'API Key',
    'dialog.paperdraw.baseUrl': 'Base URL',
    'dialog.paperdraw.model': 'Mô hình',
    'dialog.paperdraw.error.noApiKey': 'Vui lòng cấu hình API Key trước',
