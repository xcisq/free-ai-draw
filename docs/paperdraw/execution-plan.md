...
- `P2-3`：结构 QA 第一轮落地，优先接入主干确认、可省略连线、模块角色确认

### 下一轮计划

- `P2-3` 第二轮：补 merge / feedback 结构确认问题
- `P3-1`：让 `pipeline-layout-intent` 更强地消费 QA 产出的模块角色和主干确认结果
...
- 下一轮补充：merge 节点确认、feedback 边确认、UI 展示标签优化
